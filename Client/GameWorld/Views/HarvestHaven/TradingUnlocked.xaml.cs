...
namespace GameWorld.Views
{
    public partial class TradingUnlocked : Window
    {
        ...
        private async void SwitchToCancelTrade(Trade trade)
        {
            ...
            Resource resource1 = await resourceService.GetResourceByIdAsync(trade.ResourceToGive.Id);
            ...
            Resource resource2 = await resourceService.GetResourceByIdAsync(trade.ResourceToGetResource.Id);
        ...
        private async void GetAllTrades()
        {
            try
            {
                ...
                foreach (Trade item in tradeList)
                {
                    ...
                    Resource resource1 = await resourceService.GetResourceByIdAsync(item.ResourceToGetResource.Id);
                    ResourceType resourceType1 = resource1.ResourceType;
                    ...
                    Resource resource2 = await resourceService.GetResourceByIdAsync(item.ResourceToGive.Id);
                    ResourceType resourceType2 = resource2.ResourceType;
