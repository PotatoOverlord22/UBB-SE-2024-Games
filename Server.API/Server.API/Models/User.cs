namespace Server.API.Models
{
    public class User
    {
        ...
        public User(Guid id, string username, int coins = 0, int amountOfItemsBought = 0, int amountOfTradesPerformed = 0,
            DateTime? tradeHallUnlockTime = null, DateTime? lastTimeReceivedWater = null, string userCurrentIconPath = DEFAULT_USER_CURRENT_ICON_PATH, int userChips = DEFAULT_USER_CHIPS,
            ...
            int userTablePlace = DEFAULT_USER_TABLE_PLACE, DateTime userLastLogin = default(DateTime))
        {
            ...
            Username = username;
            Coins = coins;
            AmountOfItemsBought = amountOfItemsBought;
            AmountOfTradesPerformed = amountOfTradesPerformed;
